...
class TestRootTopic(BaseTestCase):
    ...
    def setUpClass(cls) -> None:
        super(TestRootTopic, cls).setUpClass()
        cls.url_prefix = "/api/root_topics"
        cls.root_topic1 = {"name": "root_topic1"}
        cls.root_topic2 = {"name": "root_topic2"}
        cls.topic1 = {"name": "Topic1"}
        cls.topic2 = {"name": "Topic2"}
        cls.topic3 = {"name": "Topic3"}
