...
class TestPost(BaseTestCase):
    def setUp(self):
        ...
        self.user1 = {"email": uuid4().hex + "hrui8005@gmail.com", "password": "11Aa*%$#"}
        self.user2 = {"email": uuid4().hex + "hrui8006@gmail.com", "password": "11Aa*%$#"}
    ...
    def test_update_post(self):
        res = self.client.post(self.url_prefix, json=self.posts1)

        new_post = {"user_id": 1, "content": "this is new post"}
        resp = self.client.put(self.url_prefix + f"/{res.json['data']['id']}", json=new_post).json["data"]
    ...
    def test_get_posts(self):
        ...
        self.assertEqual("this is post 5", topics[0]["content"])
